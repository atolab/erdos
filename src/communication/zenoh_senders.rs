...
#[cfg(feature = "zenoh_transport")]
pub(crate) struct ZenohDataSender {
...
#[cfg(feature = "zenoh_transport")]
pub(crate) async fn run_senders(senders: Vec<ZenohDataSender>) -> Result<(), CommunicationError> {
...
pub(crate) struct ZenohControlSender {
    /// The id of the node the sink is sending data to.
    node_id: NodeId,
    /// Self node id
    self_node_id: NodeId,
...
pub(crate) async fn run_control_senders(
    mut senders: Vec<ZenohControlSender>,
